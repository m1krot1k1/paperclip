  ...
  const disableAllMutation = useMutation({
    mutationFn: async (agentRows: InstanceSchedulerHeartbeatAgent[]) => {
      ...
      if (failures.length > 0) {
        ...
        const detail = firstError instanceof Error ? firstError.message : t("settings.unknownError");
        throw new Error(
          failures.length === 1
    ...
    onError: (error) => {
      setActionError(error instanceof Error ? error.message : t("settings.failedToDisableAll"));
    },
  });
  ...
  return (
    <div className="max-w-5xl space-y-6">
      ...
      <div className="flex items-center gap-4 text-sm text-muted-foreground">
        ...
        <span><span className="font-semibold text-foreground">{disabledCount}</span> {t("settings.disabledCount", { count: disabledCount })}</span>
        ...
        {anyEnabled && (
          <Button
            ...
            onClick={() => {
              ...
              if (!window.confirm(t("settings.disableAllConfirm", { count: enabledCount, noun }))) {
                return;
              }
                    ...
                    return (
                      ...
                      >
                        ...
                        <span className="ml-auto flex items-center gap-1.5 shrink-0">
                          ...
                          >
                            {saving ? "..." : agent.heartbeatEnabled ? t("settings.disableTimer") : t("settings.enableTimer")}
                          </Button>
                        </span>
                      </div>
                    );
