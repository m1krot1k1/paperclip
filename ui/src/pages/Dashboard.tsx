        ...
        <>
              ...
              <div className="flex items-start gap-2.5">
                ...
                <div>
                  <p className="text-sm font-medium text-red-950 dark:text-red-50">
                    {t(data.budgets.activeIncidents === 1
                      ? "dashboard.activeBudgetIncident"
                      : "dashboard.activeBudgetIncidents", { count: data.budgets.activeIncidents })}
                  </p>
          ...
          <div className="grid grid-cols-2 xl:grid-cols-4 gap-1 sm:gap-2">
            <MetricCard
              ...
              description={
                <span>
                  {t("dashboard.agentStatusSummary", {
