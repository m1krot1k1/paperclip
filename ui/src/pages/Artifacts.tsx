...
export const ARTIFACT_KIND_FILTERS: { value: ArtifactKindFilter; labelKey: string }[] = [
  { value: "all", labelKey: "artifacts.filters.all" },
  { value: "image", labelKey: "artifacts.filters.images" },
  { value: "video", labelKey: "artifacts.filters.videos" },
  { value: "document", labelKey: "artifacts.filters.documents" },
  { value: "text", labelKey: "artifacts.filters.text" },
  { value: "file", labelKey: "artifacts.filters.files" },
];

export const ARTIFACT_GROUP_OPTIONS: { value: ArtifactGroupBy; labelKey: string }[] = [
  { value: "none", labelKey: "artifacts.group.none" },
  { value: "task", labelKey: "artifacts.group.task" },
  { value: "parent_task", labelKey: "artifacts.group.parentTask" },
];
...
export function artifactGroupByLabel(
  ...
  const option = ARTIFACT_GROUP_OPTIONS.find((item) => item.value === value);
  return translate(option?.labelKey ?? "artifacts.group.none");
}
...
export function Artifacts() {
  ...
  const emptyMessage = showGroupCards
    ...
    : searching
      ? t("artifacts.empty.search")
      : viewingSelectedStack
        ? t("artifacts.empty.stackFilters")
        : kind === "all"
          ? t("artifacts.empty.all")
    ...
    <div className="w-full max-w-6xl space-y-5">
      <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
        ...
        <div className="flex flex-wrap items-center gap-1.5">
          <DropdownMenu>
            <DropdownMenuTrigger asChild>
              <Button
                ...
                variant="outline"
                size="icon"
                aria-label={t("artifacts.groupLabel", { current: artifactGroupByLabel(groupBy, t) })}
          ...
          <div className="flex flex-wrap items-center gap-1.5" role="tablist" aria-label={t("artifacts.filterLabel")}>
