...
export function Projects() {
  ...
  const sortLabel = projectSortOptions.find((option) => option.field === sortField)?.label ?? t("projects.sortName");
        ...
        <Popover>
          <PopoverTrigger asChild>
            <Button variant="ghost" size="sm" className="w-fit text-xs" title={t("common.sort")}>
              ...
              <span>{t("projects.sort", { label: sortLabel })}</span>
            </Button>
          </PopoverTrigger>
              ...
              <section key={label} className="space-y-2">
                <div className="flex items-center justify-between">
                  ...
                  <span className="text-xs text-muted-foreground">
                    ...
                    {t(sectionProjects.length === 1 ? "projects.project" : "projects.projects")}
                  </span>
                </div>
                        ...
                        trailing={
                          <div className="flex items-center gap-3">
                            <span
                              ...
                              title={t(
                                (project.taskCount ?? 0) === 1 ? "projects.taskCount" : "projects.tasksCount",
