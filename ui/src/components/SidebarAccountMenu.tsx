...
export function SidebarAccountMenu({
  ...
  const displayName = session?.user.name?.trim() || t("account.boardLabel");
  const secondaryLabel =
    session?.user.email?.trim() || (deploymentMode === "authenticated" ? t("account.signedInLabel") : t("account.localWorkspaceBoard"));
        ...
        >
          ...
          <div className="-mt-8 px-4 pb-4">
            ...
            <div className="mt-4 space-y-1">
              ...
              <LanguageSwitcher onAfterSelect={() => setOpen(false)} />
