      ...
      >
          ...
          <div>
            ...
            <div className="flex items-center gap-2">
              <input
                ...
                placeholder={t("dialogs.localFolderPlaceholder")}
              />
              <ChoosePathButton />
            </div>
          </div>
        ...
        <div className="flex items-center justify-between px-4 py-2.5 border-t border-border">
          {createProject.isError ? (
                  <p className="text-xs text-destructive">{t("dialogs.failedToCreateProject")}</p>
          ) : (
            <span />
          )}
          <Button
