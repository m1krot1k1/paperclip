...
import { printOpenAICompatibleStreamEvent } from "@paperclipai/adapter-openai-compatible/cli";
...
const openAICompatibleCLIAdapter: CLIAdapterModule = {
